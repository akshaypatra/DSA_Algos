...
class Solution:
    def findAllRecipes(self, recipes: List[str], ingredients: List[List[str]], supplies: List[str]) -> List[str]:
        '''
            #Solution : Using graph as a data structure   
        ...
        def dfs(r):
            ...
            can_cook[r]=False #circular dependency
        ...
        # First Approach : using bruteforce to check every ingredient using 2 for loops .
