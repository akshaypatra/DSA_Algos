...
class Solution:
    def minOperations(self, boxes: str) -> List[int]:
        ...
        #Bruteforce solution : All test cases passed
        ...
        for i in range(len(boxes)):
            total_shifts=0
            for j in pos:
                total_shifts+=abs(j-i)
            res.append(total_shifts)
        return res
        ...
        '''
        count number of 1s(balls) to the left and to the right and the moves to left and moves to the right 
